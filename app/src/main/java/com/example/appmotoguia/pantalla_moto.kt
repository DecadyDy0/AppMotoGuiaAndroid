...
class pantalla_moto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pantalla_moto)
    ...
    private fun abrirEditarMotoActivity() {
        ...
        startActivityForResult(intent, AdminMotoActivity.REQUEST_CODE_EDITAR_MOTO)
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data)
        if (requestCode == AdminMotoActivity.REQUEST_CODE_EDITAR_MOTO && resultCode == RESULT_OK) {
